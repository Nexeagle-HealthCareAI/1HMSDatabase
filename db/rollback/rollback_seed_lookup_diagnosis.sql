/*
  easyHMS Rollback: Remove DIAGNOSIS items seeded by this migration
  SeedId: 2025-11-01-DIAG
  Scope: Deletes only rows where LookupTypeId=5 AND MetaJson.seed_id = SeedId
